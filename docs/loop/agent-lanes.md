...
| --- | --- | --- | --- | --- | --- | --- | --- |
| data-eng | 019fxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx | Own statement ingestion, normalization, deduplication, categorization, storage, aggregation, API contracts, OCR boundary, and core tests. | backend/**; contracts/**; scripts/**; tests/backend/**; docs/data/**; docs/loop/lanes/data-eng/** | docs/loop/lanes/data-eng/worklog.md | registered | 2026-07-14T06:57:02Z | highest |
...
| product | 019fxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx | Own goals, specs, acceptance criteria, milestones, privacy boundaries, and final product judgment. | docs/loop/**; docs/product/**; README.md; .gitignore | docs/loop/lanes/product/worklog.md | registered | 2026-07-14T07:00:15Z | highest |
