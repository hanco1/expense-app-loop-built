...
- Active human-authorized override: `REQ-20260715-091230-frontend` iteration 3 may use `max_fix_cycles: 5` only to close the live-QA default-port collision and exclusive-bind failure class; restore the standing cap to `3` in the same checkpoint as `ACCEPTED`.
