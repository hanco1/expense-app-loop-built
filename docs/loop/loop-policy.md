...
- Active human-authorized override: `REQ-20260715-091230-frontend` iteration 4 may use `max_fix_cycles: 7` only to close the diagnosed repeated-stripe donut rendering class; restore the standing cap to `3` in the same checkpoint as `ACCEPTED`.
