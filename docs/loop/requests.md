...
| REQ-20260714-064051-data-eng | FIX_REQUESTED | review | 3 | docs/loop/goal.md; docs/loop/tracker.md; docs/loop/constraints.md; docs/product/analysis-core.md; docs/review/REQ-20260714-064051-data-eng-iter-2.md | docs/loop/messages/REQ-20260714-064051-data-eng/REVIEW_REQUEST-component-matrix-iter-3.md | Freeze the complete same_transaction component-state by state-changing-operation matrix and consolidated red acceptance before product dispatches the single data-eng iteration-3 FIX_REQUEST. | 2026-07-14T17:55:58Z |
