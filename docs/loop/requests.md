...
| REQ-20260713-073512-data-eng | FIX_REQUESTED | data-eng | 3 | docs/loop/goal.md; docs/loop/tracker.md; docs/loop/constraints.md; docs/product/import-pipeline.md | docs/loop/messages/REQ-20260713-073512-data-eng/FIX_REQUEST-iter-3.md | Catch every Decimal construction/arithmetic/comparison/conversion exception as row-level invalid_amount, retain the source row, add NaN and overflowing-exponent backend regressions, and return all iteration-3 evidence for independent review. | 2026-07-13T08:50:46Z |
