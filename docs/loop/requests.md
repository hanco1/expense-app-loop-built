...
| REQ-20260713-073512-data-eng | BLOCKED | product | 3 | docs/loop/goal.md; docs/loop/tracker.md; docs/loop/constraints.md; docs/product/import-pipeline.md | docs/loop/messages/REQ-20260713-073512-data-eng/BLOCKED-review-iter-3.md | Ask the human whether to authorize one additional narrowly scoped exact-money correction; do not accept e94a09a while nonzero Decimal underflow can become zero cents. | 2026-07-13T08:59:41Z |
