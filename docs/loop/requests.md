...
| REQ-20260713-073512-data-eng | REQUESTED | data-eng | 1 | docs/loop/goal.md; docs/loop/tracker.md; docs/loop/constraints.md; docs/product/import-pipeline.md | docs/loop/messages/REQ-20260713-073512-data-eng/IMPLEMENTATION_REQUEST-iter-1.md | Implement the bounded TD-style CSV/text-PDF import pipeline, record all declared evidence, then send IMPLEMENTATION_DONE and REVIEW_REQUEST. | 2026-07-13T07:35:12Z |
