...
| REQ-20260713-073512-data-eng | FIX_REQUESTED | data-eng | 2 | docs/loop/goal.md; docs/loop/tracker.md; docs/loop/constraints.md; docs/product/import-pipeline.md | docs/loop/messages/REQ-20260713-073512-data-eng/FIX_REQUEST-iter-2.md | Prevent rejected imports from leaving partial active/effective state, retain non-storable amounts as explicit failures or roll back atomically, add regression coverage, and return iteration-2 evidence. | 2026-07-13T07:56:00Z |
