...
| REQ-20260714-064051-data-eng | FIX_REQUESTED | review | 4 | docs/loop/goal.md; docs/loop/tracker.md; docs/loop/constraints.md; docs/product/analysis-core.md; docs/review/REQ-20260714-064051-data-eng-iter-3-component-state-matrix.md; docs/review/REQ-20260714-064051-data-eng-iter-3.md | docs/loop/messages/REQ-20260714-064051-data-eng/REVIEW_REQUEST-write-boundary-matrix-iter-4.md | Freeze the complete exposed-writer by proposal-class matrix before data-eng starts; preserve the original 56-path matrix and enumerate every invalid and valid public write path. | 2026-07-15T07:45:17Z |
