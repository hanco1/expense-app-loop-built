...
| REQ-20260715-091230-frontend | FIX_REQUESTED | frontend | 2 | docs/loop/goal.md; docs/loop/constraints.md; docs/product/local-web-api.md; docs/product/local-web-app.md; docs/review/REQ-20260715-091230-frontend-iter-1.md; tests/acceptance/test_local_web_app_review.py | docs/loop/messages/REQ-20260715-091230-frontend/FIX_REQUEST-iter-2.md | Claim iteration 2 only after this durable owner transfer; route every public HTTP method through the Host-first structured security boundary and separate committed mutation acknowledgement from any later canonical-refresh failure across import, category, duplicate, and undo flows, then return unchanged review acceptance plus all original gates. | 2026-07-15T09:47:46Z |
