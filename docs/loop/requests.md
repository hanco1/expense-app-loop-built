...
| REQ-20260715-091230-frontend | FIX_REQUESTED | frontend | 4 | docs/loop/goal.md; docs/loop/constraints.md; docs/product/local-web-api.md; docs/product/local-web-app.md; docs/review/REQ-20260715-091230-frontend-iter-4-pie-geometry-boundary.md; tests/acceptance/test_local_web_app_pie_geometry_review.py | docs/loop/messages/REQ-20260715-091230-frontend/FIX_REQUEST-iter-4.md | Implement the frozen bounded-geometry contract: preserve exact 1e9 BigInt accounting/data-units but keep CSS/SVG lengths bounded; render nine single contiguous June arcs with Housing dominant and tiny categories visible; make the unchanged 720-sample acceptance and all prior gates green. | 2026-07-15T21:15:56Z |
