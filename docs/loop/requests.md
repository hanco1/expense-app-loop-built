...
| REQ-20260713-073512-data-eng | BLOCKED | product | 2 | docs/loop/goal.md; docs/loop/tracker.md; docs/loop/constraints.md; docs/product/import-pipeline.md | docs/loop/messages/REQ-20260713-073512-data-eng/BLOCKED-review-iter-2.md | Ask the human whether to raise max_fix_cycles from 3 to 4; commit 6bca89e cannot pass because Decimal exceptions drop the candidate source row instead of retaining invalid_amount. | 2026-07-13T08:07:20Z |
